...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Blocking phase: find inductive clauses incrementally.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item IIC functional and competitive.
		\item IIC still under active R\&D.
		\item Still some corner case bugs to work out with non-reduced aigers.
	\end{itemize}
\end{frame}
\begin{frame}
